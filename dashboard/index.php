    ...
    <div id="tab-inicio" class="tab-content active">
        <div class="container">
            ...
            <div class="dashboard-grid">
                ...
                <a href="https://tictac-comunicacion.es/gestion-dominios/?gd_u=tictac&gd_p=Sipilu2019" target="_blank" class="dashboard-card active">
                    <div class="card-icon">🌐</div>
        ...
        <div class="container">
            ...
            <div id="container-proyectos">
                <div class="venc-empty">
                    <div style="font-size:48px;margin-bottom:12px;">⏳</div><strong>Cargando...</strong>
                </div>
            </div>
        </div>
    </div>

    ...
    <form id="contratoForm" class="editor-container">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label>Emails de contacto * <span style="font-weight:400;color:#888;font-size:12px;">(separa varios con coma: email1@empresa.com, email2@empresa.com)</span></label>
        ...
        <!-- CLÁUSULAS LEGALES EDITABLES -->
        <div class="form-section">
            <h3>📋 Cláusulas del Contrato</h3>
            <div class="form-group">
                <label>
                    Cláusulas legales — Déjalo vacío para usar las <strong>cláusulas estándar</strong> de Tictac.
                    Si escribes aquí, <strong>reemplazarán</strong> las cláusulas estándar en el PDF.
                </label>
                ...
                <div style="margin:8px 0;">
                    <button type="button" onclick="cargarClausulasDefault()" style="background:#E91E8C;color:white;border:none;padding:8px 18px;border-radius:20px;cursor:pointer;font-size:13px;font-weight:600;">
                        📋 Cargar cláusulas estándar para editar
                    </button>
                    <button type="button" onclick="limpiarClausulas()" style="background:#6c757d;color:white;border:none;padding:8px 18px;border-radius:20px;cursor:pointer;font-size:13px;font-weight:600;margin-left:8px;">
        ...
        <!-- NOTAS / CLÁUSULAS ADICIONALES -->
        <div class="form-section">
            <h3>📝 Notas Adheridas al Contrato</h3>
            <div class="form-group">
                <label>Notas adicionales (opcional) — Aparecerá al final del contrato PDF en la sección "NOTAS ADHERIDAS AL CONTRATO"</label>
...
function limpiarClausulas() {
    if (!confirm("¿Vaciar el editor de cláusulas? El PDF usará las cláusulas estándar automáticamente.")) return;

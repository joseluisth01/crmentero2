    ...
    $(document).ready(function() {
        ...
        $("#proposal-table").appTable({
            ...
            filterDropdown: [{
                name: "status",
                class: "w150",
                options: <?php echo view("proposals/proposal_statuses_dropdown"); ?>
            }, <?php echo $custom_field_filters; ?>],
            rangeDatepicker: [{
                    startDate: {
                        name: "last_email_seen_start_date",
                        value: ""
                    },
                    endDate: {
                        name: "last_email_seen_end_date",
                        value: ""
                    },
                    showClearButton: true,
                    label: "<?php echo app_lang('last_email_seen'); ?>",
                    ranges: ['today', 'yesterday', 'last_7_days', 'last_30_days', 'this_month', 'last_month']
                },
                {
                    startDate: {
                        name: "last_preview_seen_start_date",
                        value: ""
                    },
                    endDate: {
                        name: "last_preview_seen_end_date",
                        value: ""
                    },
                    showClearButton: true,
                    label: "<?php echo app_lang('last_preview_seen'); ?>",
                    ranges: ['today', 'yesterday', 'last_7_days', 'last_30_days', 'this_month', 'last_month']
                }
            ],
            columns: [{
                    title: "<?php echo app_lang("proposal") ?> ",
                    "class": "all"
                },
                {
                ...
                {
                    title: "<?php echo app_lang("proposal_date") ?>",
                    "iDataSort": 2,
                    "class": "w100"
                },
                {
                ...
                {
                    title: "<?php echo app_lang("valid_until") ?>",
                    "iDataSort": 4,
                    "class": "w100"
                },
                {
                    title: "<?php echo app_lang("last_email_seen") ?>",
                    "class": "text-center"
                },
                {
                    title: "<?php echo app_lang("last_preview_seen") ?>",
                    "class": "text-center"
                },
                {
                ...
                {
                    visible: showCommentOption,
                    title: "<?php echo app_lang("comments") ?>",
                    "class": "text-center w50"
                }
                <?php echo $custom_field_headers; ?>,
                {
                    title: "<i data-feather='menu' class='icon-16'></i>",
                    "class": "text-center w140",

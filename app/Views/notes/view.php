...
<div class="modal-footer">
    ...
    if ($login_user->user_type === "staff") {
        echo modal_anchor(
            get_uri("notes/modal_form"),
            "<i data-feather='edit-2' class='icon-16'></i> " . app_lang('edit_note'),
            array(
                "class" => "btn btn-default",
                "data-post-id" => $model_info->id,
                "title" => app_lang('edit_note')
            )
        );
    }
    ?>
    <button type="button" class="btn btn-default close-modal" data-bs-dismiss="modal">
